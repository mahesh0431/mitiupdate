					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Response/Mitigation Update",
									"targetURL": "#mitiupdate-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"mitiupdate-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mitiupdate",
									"url": sap.ui.require.toUrl("mitiupdate")
								}
							}
						}
					}
